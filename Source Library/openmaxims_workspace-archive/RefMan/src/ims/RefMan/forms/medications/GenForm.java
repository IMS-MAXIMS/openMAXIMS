...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 1011), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 1007), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.contextMenuMedicationMultipleDoses, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ID", "ID_PatientMedication");
			fields[72] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-OTHERMEDICATIONTEXT", "OtherMedicationText");
			fields[73] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-PATIENT", "Patient");
			fields[74] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-FREQUENCY", "Frequency");
			fields[75] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-SOURCEOFINFORMATION", "SourceofInformation");
			fields[76] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-COMMENCEDDATE", "CommencedDate");
			fields[77] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-NODAYSSUPPLY", "NoDaysSupply");
			fields[78] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-BATCHNO", "BatchNo");
			fields[79] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-EXPIRYDATE", "ExpiryDate");
			fields[80] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISDISCONTINUED", "IsDiscontinued");
			fields[81] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-DIFFICULTIESWITHMED", "DifficultiesWithMed");
			fields[82] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-SUPPLIED", "Supplied");
			fields[83] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-INPOSSESSION", "InPossession");
			fields[84] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISMEDICATIONONADMISSION", "IsMedicationonAdmission");
			fields[85] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISDISCHARGEMEDICATION", "IsDischargeMedication");
			fields[86] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-CARECONTEXT", "CareContext");
			fields[87] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISINTTO", "IsInTTO");
			fields[88] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISDISCONTINUEDDATE", "IsDiscontinuedDate");
			fields[89] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISDISCONTINUEDREASON", "IsDiscontinuedReason");
			fields[90] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISDISCONTINUEDREASONTEXT", "IsDiscontinuedReasonText");
			fields[91] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISCOPIED", "IsCopied");
			fields[92] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-COMMENCEDBYTYPE", "CommencedByType");
			fields[93] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-DISCONTINUEDBYTYPE", "DiscontinuedByType");
			fields[94] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-SELFMEDICATING", "SelfMedicating");
			return fields;
		}
