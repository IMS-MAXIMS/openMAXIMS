...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.TheatreTrackingStatusColourConfig.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100051-ID", "ID_TheatreTrackingStatusColourConfig");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.TheatreTrackingStatusColourConfig.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100051-TRACKINGSTATUS", "TrackingStatus");
			fields[73] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.TheatreTrackingStatusColourConfig.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100051-COLOUR", "Colour");
			return fields;
		}
